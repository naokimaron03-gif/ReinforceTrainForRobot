function in = walkerResetFcn(in, varargin)
    ...
    in = setVariable(in, 'AncleDegInit_R', -(Randomize_Angle(1) + Randomize_Angle(3)));
    in = setVariable(in, 'AncleDegInit_L', -(Randomize_Angle(2) + Randomize_Angle(4)));
end